# Awesome List 🌟 [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) ![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/00xBAD/awesome-list/.github%2Fworkflows%2Fbuild.yml)
